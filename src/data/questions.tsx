    ...
    topics: [
      {
        ...
        questions: [
          ...
          },
          {
            ...
            answer: <div>Нет, деталь автомобиля производят на разных заводах. Потом детали привозят на сборочный завод, чтобы из них собрать готовый автомобиль.</div>
          },
          {
      ...
      },
      {
        ...
        questions: [
          ...
          },
          {
            ...
            answer: <div>BS - антиблокировочная система. Она позволяет избежать блокировки тормозов и дать водителю возможность рулить при экстренном торможении.</div>
          },
          {
